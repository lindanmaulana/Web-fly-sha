...
import { FlightsWithPlane } from "@/lib/types/flights"
        ...
        const column: ColumnDef<Flight>[] = [
                ...
                cell: ({row}) => {
                    ...
                    return (
                        <div className="inline-flex items-center gap-5">
                            <Image src={imageUrl} alt={flight.plane.name} width={120} height={120} className="rounded-xl" />
            ...
            },
            {
                ...
                cell: ({row}) => {
                    ...
                    return <ColumnSeatPrice flight={{flight: flight, seat: flight.seats}} />
                }
            },
            {
                id: "actions",
